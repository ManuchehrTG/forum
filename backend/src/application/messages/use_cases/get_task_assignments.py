...
from src.application.messages.queries import GetTaskAssignmentsQuery
...
class GetTaskAssignments:
	def __init__(self, message_repo: MessageRepository):
		self.message_repo = message_repo

	@handle_domain_errors
	async def execute(self, query: GetTaskAssignmentsQuery) -> List[MessageDTO]:
